...
${OBJECTDIR}/AtcGpsInfo.o: AtcGpsInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AtcGpsInfo.o AtcGpsInfo.cpp

${OBJECTDIR}/ClientBenchmarkClass.o: ClientBenchmarkClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientBenchmarkClass.o ClientBenchmarkClass.cpp

${OBJECTDIR}/ClientClass.o: ClientClass.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ClientClass.o ClientClass.cpp
